...
# Script d'installation de ShinOS - version complète
# Prévu pour une base Debian ou Raspberry Pi OS Lite
...
feh --bg-scale ~/shinos-config/wallpapers/shinos-wallpaper.png

# --- 6. Lancer automatiquement l'environnement au démarrage ---
echo "[6/7] Configuration de l'autostart..."
echo "exec i3" > ~/.xinitrc

# --- 7. Installation de LibreWolf via Flatpak (optionnel mais recommandé) ---
echo "[7/7] Installation de LibreWolf (Flatpak)..."
